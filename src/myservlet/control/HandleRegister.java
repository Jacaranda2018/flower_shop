...
public class HandleRegister extends HttpServlet{
		...
		public void doPost(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException{
				  ...
				  if(boo)
				  {
				   ...
				   backNews="注册成功";
				    ...
				    response.setContentType("text/html;charset=GB2312");
						 ...
						 out.print("<a href = login.jsp style='text-decoration : none;color:#000000'><h3 align=center>前往登录</a>");
						 out.print("<a href = index.jsp style='text-decoration : none;color:#000000'><h3 align=center>返回主页</a>");
			...
			try {
				 ...
				 //out.print("<img src='image/4.jpg' width=1420 height=400px></img>");
				 out.print("<a href = index.jsp style='text-decoration : none;color:#FF5809'><h3 align=center>返回主页</a>");
